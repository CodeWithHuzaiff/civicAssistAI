export function getAnalysisSystemPrompt(schemeDetails) {
...
export function getAnalysisUserPrompt(userProfile) {
...
export function getTranslationPrompt(targetLanguage) {
